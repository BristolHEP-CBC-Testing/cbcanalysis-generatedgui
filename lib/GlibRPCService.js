...
$pyjs['loaded_modules']['GlibRPCService'] = function (__mod_name__) {
	...
	, 3, [null,null]);
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			$m['JSONProxy']['__init__'](self, 'services/GlibControlProxy.py', $p['list'](['getStates', 'connectedCBCNames', 'I2CRegisterValues', 'setI2CRegisterValues', 'saveStateValues', 'loadStateValues', 'startProcesses', 'killProcesses', 'boardIsReachable', 'stopTakingData', 'startSCurveRun', 'startOccupancyCheck', 'getDataTakingStatus', 'getOccupancies']));
			return null;
		}
	, 1, [null,null,['self']]);
