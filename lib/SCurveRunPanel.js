...
$pyjs['loaded_modules']['SCurveRunPanel'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['code'],['message'],['request_info']]);
		...
		$cls_definition['DoNothingListener'] = (function(){
			...
			$method = $pyjs__bind_method2('onRemoteResponse', function(response, request_info) {
				...
				var $add2,$add1;
				$m['ErrorMessage']($p['__op_add']($add1='Unable to contact server: ',$add2=$p['str'](response)));
				return null;
			}
	, 1, [null,null,['self'],['response'],['request_info']]);
			$cls_definition['onRemoteResponse'] = $method;
	...
	, 1, [null,null,['self'],['code'],['message'],['request_info']]);
		...
		$method = $pyjs__bind_method2('__init__', function(rpcService) {
			...
			self['mainSettings']['add'](self['createControlPanel']($p['list'](['RangeLo', 'RangeHi', 'Steps', 'FileName'])));
			self['echo'] = $m['Label']();
			self['launchButton'] = $m['Button']('Launch Now');
			self['launchButton']['addClickListener'](self);
			self['launchButton']['setEnabled'](true);
			self['getStatusButton'] = $m['Button']('Get Status');
			...
			self['mainPanel']['add']($p['getattr'](self, 'getStatusButton'));
			self['mainPanel']['add']($p['getattr'](self, 'echo'));
			self['timer'] = $pyjs_kwargs_call(null, $m['Timer'], null, null, [{'notify':$p['getattr'](self, 'updateStatus')}]);
	...
	, 1, [null,null,['self'],['sender']]);
		...
		$method = $pyjs__bind_method2('onClick', function(sender) {
			...
			if ($p['bool']($p['op_eq'](sender, $p['getattr'](self, 'launchButton')))) {
				...
				self['rpcService']['startSCurveRun'](null, $m['SCurveRunPanel']['DoNothingListener']());
			}
			return null;
		}
	, 1, [null,null,['self'],['sender']]);
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('createControlPanel', function(controlNames) {
			...
			var newTextBox,maxWidth,$iter3_type,$iter4_type,$iter4_iter,buttonName,$iter3_idx,$iter2_iter,$$label,$iter3_iter,flowPanel,$iter2_type,$iter2_idx,$iter3_array,$mul4,$mul3,$mul2,$mul1,$iter2_nextval,$iter4_nextval,newPanel,$iter4_idx,newLabels,$iter4_array,$iter3_nextval,$iter2_array;
