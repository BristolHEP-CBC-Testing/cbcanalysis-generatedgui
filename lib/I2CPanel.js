...
$pyjs['loaded_modules']['I2CPanel'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['code'],['message'],['request_info']]);
		...
		$method = $pyjs__bind_method2('__init__', function() {
			...
			cbcListAndCallSettings = $m['VerticalPanel']();
			cbcListAndCallSettings['add']($p['getattr'](self, 'cbcList'));
			cbcListAndCallSettings['add']($p['getattr'](self, 'callSettings'));
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('createRegisterPanel', function(registerNames) {
			...
			var $iter11_idx,newTextBox,$iter11_iter,$iter11_type,newPanel,$$label,statusBox,$iter11_array,$iter11_nextval,flowPanel,buttonName;
			...
			while (typeof($p['__wrapped_next']($iter11_nextval)['$nextval']) != 'undefined') {
				...
				newPanel['setCellHorizontalAlignment'](newTextBox, $p['getattr']($m['HasHorizontalAlignment'], 'ALIGN_RIGHT'));
				newPanel['setCellHorizontalAlignment'](statusBox, $p['getattr']($m['HasHorizontalAlignment'], 'ALIGN_RIGHT'));
	...
	, 1, [null,null,['self'],['registerNames']]);
		...
		$method = $pyjs__bind_method2('createStatesPanel', function() {
			...
			var vertPanel,selectionNames,checkBox,name,launch,$iter12_array,fileTextBox,$iter12_nextval,$iter12_iter,state,$$label,$iter12_idx,registerSelection,$iter12_type;
			...
			$iter12_iter = selectionNames;
			$iter12_nextval=$p['__iter_prepare']($iter12_iter,false);
			while (typeof($p['__wrapped_next']($iter12_nextval)['$nextval']) != 'undefined') {
				name = $iter12_nextval['$nextval'];
...
/*
PYJS_DEPS: ['pyjamas.ui.HorizontalPanel.HorizontalPanel', 'pyjamas', 'pyjamas.ui', 'pyjamas.ui.HorizontalPanel', 'pyjamas.ui.VerticalPanel.VerticalPanel', 'pyjamas.ui.VerticalPanel', 'pyjamas.ui.FlowPanel.FlowPanel', 'pyjamas.ui.FlowPanel', 'pyjamas.ui.DisclosurePanel.DisclosurePanel', 'pyjamas.ui.DisclosurePanel', 'pyjamas.ui.ListBox.ListBox', 'pyjamas.ui.ListBox', 'pyjamas.ui.Label.Label', 'pyjamas.ui.Label', 'pyjamas.ui.TextBox.TextBox', 'pyjamas.ui.TextBox', 'ErrorMessage.ErrorMessage', 'ErrorMessage', 'pyjamas.ui.CheckBox.CheckBox', 'pyjamas.ui.CheckBox', 'pyjamas.ui.Button.Button', 'pyjamas.ui.Button', 'pyjamas.ui.HTML.HTML', 'pyjamas.ui.HTML', 'pyjamas.ui.HasHorizontalAlignment', 'pyjamas.Timer.Timer', 'pyjamas.Timer', 'datetime.datetime', 'datetime', 'GlibRPCService.GlibRPCService', 'GlibRPCService']
*/
