...
$pyjs['loaded_modules']['DisplayHistogramsPanel'] = function (__mod_name__) {
	...
	, 1, [null,null,['self'],['sender']]);
		...
		$method = $pyjs__bind_method2('updateHistogram', function() {
			...
			var $iter5_nextval,parameters,$iter5_array,$pyjs_try_err,cbcName,selectedChannels,$iter5_idx,$iter5_type,$iter5_iter;
			...
			if ($p['bool']($p['op_eq'](selectedChannels, $p['dict']([])))) {
			...
			$iter5_iter = $p['getattr'](self, 'connectedCBCs');
...
/*
PYJS_DEPS: ['pyjamas.ui.HorizontalPanel.HorizontalPanel', 'pyjamas', 'pyjamas.ui', 'pyjamas.ui.HorizontalPanel', 'pyjamas.ui.VerticalPanel.VerticalPanel', 'pyjamas.ui.VerticalPanel', 'pyjamas.ui.ListBox.ListBox', 'pyjamas.ui.ListBox', 'pyjamas.ui.Button.Button', 'pyjamas.ui.Button', 'pyjamas.ui.Image.Image', 'pyjamas.ui.Image', 'pyjamas.ui.HasHorizontalAlignment', 'GlibRPCService.GlibRPCService', 'GlibRPCService', 'ErrorMessage.ErrorMessage', 'ErrorMessage']
*/
